...
class Box extends Component{
    render(){
        return (
            ...
            <div className={`bild-0the-winfos ${this.props.openBox==true?"active":""}`}>
               {this.props.data.id?           <div className="rjfiektjkf">
               <div className="titl-tjeteee">
                <div className="firat-boxnf"></div>
    <div onClick={()=>{this.props.hanhdlePop(false,{})}} className="fnjerrk"><VscChromeClose/></div>
</div>
...
<div className="clai-hoxnf-irsojr-djns">
    <div className="bokd0-onjdf">
        ...
        <div className="fjrjrj">RanK #1</div>
            <div className="fhjemn"><AiFillStar/><p>204004040 people like this</p></div>
        </div>
...
{this.props.data.symbol? <p className="fjejntj">{this.props.data.symbol}</p>   :""}
    ...
    <div className="hoks0--smaol-toks">
        10000000000000
    </div>
    ...
    <div className="tshjrr">
        <div className="incokjjjf">
            Market Cap
        </div>
        <div className="infojs-fjfj">${this.props.data.market_cap}</div>
    </div>
    <div className="tshjrr">
        <div className="incokjjjf">
   24 Hour Trading Vol
    ...
    <div className="tshjrr">
       ...
       Fully Diluted
        ...
        <div className="infojs-fjfj">${this.props.data.fully_diluted_valuation}</div>
    </div>
    <div className="tshjrr">
        <div className="incokjjjf">
        Circulating Supply
        </div>
        <div className="infojs-fjfj">${this.props.data.circulating_supply}</div>
    </div>
    ...
    <div className="tshjrr">
      ...
      Total Supply
        ...
        <div className="infojs-fjfj">${this.props.data.total_supply}</div>
    </div>
    <div className="tshjrr">
        <div className="incokjjjf">
         Max Supply
        </div>
        <div className="infojs-fjfj">${this.props.data.max_supply}</div>
    </div>
