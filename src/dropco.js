  ...
  render() {
    return (
      <div className="fjerjjjfhrne">
        <div
          className={`wrpathe-filter-rjrtjtjke  ${
            this.state.open == true ? "active" : ""
          }`}>
          <div
            onClick={() => {
              this.handleChange("BTC", true);
            }}
            className="liasrt ">
          ...
          <div className="wropairrjr">
            ...
            <div
              onClick={() => {
                this.handleChange("Eny bits", false);
              }}
              className="liasrt">
              Eny <img src={logo} /> Bits
            </div>
          </div>
        </div>
      </div>
